...
<body>
							...
							<ul>
								<li><a href="#">Curative Treatment</a>
									<ul>
										...
										<li><a href="../FI/poultry.php">Poultry</a></li><!--/cats.php/-->
								...
								<li><a href="../FI/extensionprograms.php">Extension Programs</a> </li>
						...
						<li><a href="#">Welfare Schemes</a>
							<ul>
								...
								<li><a href="#">Fodder Seed</a>
									<ul>
										<li><a href="fodder/indent.php">Indent From The Field</a> </li>
										<li><a href="fodder/payment.php">Payment Particulars</a></li>
									</ul>
								</li>
								<li><a href="#">Chaff Cutter</a>
									<ul>
										<li><a href="chaff/indent.php">Indent From The Field</a> </li>
										<li><a href="chaff/payment.php">Payment Particulars</a></li>
									</ul>
								</li>
								<li><a href="#">Back Yard Poultry</a>
									<ul>
										<li><a href="back/indent.php">Indent From The Field</a> </li>
										<li><a href="back/payment.php">Payment Particulars</a></li>
									</ul>
								</li>
								<li><a href="#">Sunandini calf-Milk Program</a>
									<ul>
										<li><a href="sunandini/indent.php">Indent From The Field</a> </li>
										<li><a href="sunandini/payment.php">Payment Particulars</a></li>
									</ul>
								</li>
								<li><a href="#">Miltch Animals</a>
									<ul>
										<li><a href="miltch/indent.php">Indent From The Field</a> </li>
										<li><a href="miltch/payment.php">Payment Particulars</a></li>
									</ul>
								</li>
								<li><a href="#">Piggeries</a>
									<ul>
										<li><a href="pig/indent.php">Indent From The Field</a> </li>
										<li><a href="pig/payment.php">Payment Particulars</a></li>
									</ul>
								</li>
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Grounding</h2></center>
				<form action="uploadnew18.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
						
						<div class="form-group">
							  <label for="yearly">Voucher No</label>
							  <input class="form-control input-lg" id="yearly" name="vou" type="text">
						</div>
						<div class="form-group">
							  <label for="yearly">Date Of Grounding</label>
							  <input class="form-control input-lg" id="yearly" name="date" type="date">
						</div>
						<div class="form-group">
							  <label for="yearly">Place Of Grounding</label>
							  <input class="form-control input-lg" id="yearly" name="place" type="text">
						</div>
					...
					<div class="col-md-4">
					<div class="form-group">
							  <label for="yearly">Seller Name</label>
							  <input class="form-control input-lg" id="yearly" name="seller" type="text">
						</div>
						
						<div class="form-group">
							<label for="mandal">Mandal Name</label>
								<select class="form-control input-lg" id="mandal" name="mandal">
						...
						<div class="form-group">
							...
							<select class="form-control input-lg" id="village" type="text" name="village" >
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							  <label for="treat">Seller Address</label>
							  <input class="form-control input-lg" id="treat" type="text" name="sadd" >
						</div>
						<div class="form-group">
							  <label for="treat">Seller Aadhar Number</label>
							  <input class="form-control input-lg" id="treat" type="text" name="sadhar" >
						</div>
						<div class="form-group">
							  <label for="treat">Seller Account Number</label>
							  <input class="form-control input-lg" id="treat" type="text" name="sacc" >
						</div>
					</div>
					<div class="col-md-4">
						
						<div class="form-group">
							  <label for="treat">Amount Paid</label>
							  <input class="form-control input-lg" id="treat" type="text" name="apai" >
						</div>
						</div>
						<div class="col-md-4">
						<div class="form-group">
							  <label for="treat">Cheque No. Issued by the DVAHO</label>
							  <input class="form-control input-lg" id="treat" type="text" name="cdb" >
						</div></div>
						<div class="col-md-4">
						<div class="form-group">
							  <label for="treat">Date</label>
							  <input class="form-control input-lg" id="treat" type="date" name="date2" >
						</div></div>
						<div class="col-md-4">
						<div class="form-group">
							  <label for="treat">Vehicle Number</label>
							  <input class="form-control input-lg" id="treat" type="text" name="vnol" >
						</div></div>
						<div class="col-md-4">
						<div class="form-group">
							  <label for="treat">Name Of The Transporter</label>
							  <input class="form-control input-lg" id="treat" type="text" name="ntra" >
						</div></div>
						<div class="col-md-4">
						<div class="form-group">
							  <label for="treat">Amount Paid</label>
							  <input class="form-control input-lg" id="treat" type="text" name="amountp" >
						</div></div>
						<div class="col-md-4">
						<div class="form-group">
							  <label for="treat">Cheque No. Issued by the DVAHO & Date</label>
							  <input class="form-control input-lg" id="treat" type="text" name="dbch" >
						</div></div>
					...
					<div class="col-md-4">
						<button class="btn btn-warning btn-lg" type="submit" name="btn-upload">Submit</button>
					</div>
				</form>
			</div>
		</div>
