...
<body>
						...
						<li><a href="#">Welfare Schemes</a>
							<ul>
								...
								<li><a href="#">Chaff Cutter</a>
									<ul>
										<li><a href="indent.php">Indent From The Field</a> </li>
										<li><a href="payment.php">Payment Particulars</a></li>
									</ul>
								</li>
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Chaff Payment</h2></center>
				<form action="uploadnew23.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
						
						
						
						
  <label for="yearly">Type Of Chaff</label>
 	<select class="form-control input-lg" id="seed" name="seed">
				  <option>--Select Chaff From Here--</option>
				  <option name="typechaff">5HP-3Blades 3Phase</option>
				  <option name="typechaff">3HP-3Blades 3Phase</option>	  
				  <option name="typechaff">3HP-3Blades Single Phase</option>
				  <option name="typechaff">2HP-3Blades Single Phase</option>
				  <option name="typechaff">2HP-3Blades 3Phase</option>
				  <option name="typechaff">2HP-2Blades Single Phase</option>
				</select>
						
						
						<div class="form-group">
							  <label for="yearly">Full Cost</label>
							  <input class="form-control input-lg" id="yearly" name="cost" type="text">
						</div>
						<div class="form-group">
							  <label for="yearly">Subsidy</label>
							  <input class="form-control input-lg" id="yearly" name="subs" type="text">
						</div>
					...
					<div class="col-md-4">
					<div class="form-group">
							  <label for="yearly">Previously Paid</label>
							  <input class="form-control input-lg" id="yearly" name="ppaid" type="text">
						</div>
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							  <label for="treat">Present Paid</label>
							  <input class="form-control input-lg" id="treat" type="text" name="ppre" >
						</div>
						</div>
						<div class="col-md-4">
						
						<div class="form-group">
							  <label for="treat">Total Paid</label>
							  <input class="form-control input-lg" id="treat" type="text" name="tp" >
						</div>
						</div>
						<div class="col-md-4">
						
						<div class="form-group">
							  <label for="treat">Balance To Be Paid</label>
							  <input class="form-control input-lg" id="treat" type="text" name="bp" >
						</div>
						</div>
						<div class="col-md-4">
						
						<div class="form-group">
							  <label for="treat">Paid By Cash/Cheque/RTGS/Online</label>
							  <input class="form-control input-lg" id="treat" type="text" name="cro" >
						</div>
						</div>
