...
<body>
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Chaff Indent</h2></center>
				<form action="uploadnew22.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
  ...
  <label for="yearly">Type Of Chaff</label>
 	<select class="form-control input-lg" id="chaff" name="chaff">
				  ...
				  <option name="typechaff">2HP-2Blades Single Phase</option>
					...
					<div class="col-md-4">
					<div class="form-group">
							  <label for="yearly">Beneficial Contribution</label>
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							  <label for="treat">Indent Of Quality By Doctors</label>
							  <input class="form-control input-lg" id="treat" type="text" name="iq" >
						</div>
						</div>
