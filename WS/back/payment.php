...
<body>
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Backyard Payment</h2></center>
				<form action="uploadnew25.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
						
						
						
						
  <label for="yearly">Type</label>
 	<select class="form-control input-lg" id="seed" name="seed">
				  <option>--Select Type From Here--</option>
				  <option name="typechaff">Vana Raja</option>
				  <option name="typechaff">Grama Priya</option>	  
				  <option name="typechaff">Rainbow</option>
				  <option name="typechaff">Roaster</option>
				</select>
