...
<body>
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Backyard Indent</h2></center>
				<form action="uploadnew24.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
