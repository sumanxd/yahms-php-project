...
<body>
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Sunandini Payment</h2></center>
				<form action="uploadnew27.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
						
						
						
						
  <label for="yearly">Type of Calf</label>
 	<select class="form-control input-lg" id="seed" name="seed">
				  <option>--Select Type From Here--</option>
				  <option name="typechaff">HF Cross</option>
				  <option name="typechaff">Jersey</option>	  
				  <option name="typechaff">Murra</option>
				  <option name="typechaff">Ongole</option>
				  <option name="typechaff">Tarparker</option>
				</select>
