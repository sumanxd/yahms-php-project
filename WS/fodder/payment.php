...
<body>
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Fodder Payment</h2></center>
				<form action="uploadnew21.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
						
						
						
						
  <label for="yearly">Type Of Seed</label>
 	<select class="form-control input-lg" id="seed" name="seed">
				  <option>--Select Seed From Here--</option>
				  
				  <option name="typeseed">SSG</option>	  
				  <option name="typeseed">PC-23</option>
				  <option name="typeseed">COW-PEA</option>
				  <option name="typeseed">PILLI PESARA</option>
				  <option name="typeseed">STYLO</option>
				  <option name="typeseed">AFRICAN TALL MAIZE</option>
				</select>
