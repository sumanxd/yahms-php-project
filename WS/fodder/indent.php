...
<body>
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Fodder Indent</h2></center>
				<form action="uploadnew20.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
 	...
 	<select class="form-control input-lg" id="seed" name="seed">
				  ...
				  <option name="typeseed">AFRICAN TALL MAIZE</option>
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							  <label for="treat">Indent Of Quantity By Doctors</label>
							  <input class="form-control input-lg" id="treat" type="text" name="quan" >
						</div>
						</div>
