...
<body>
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Postgrounding</h2></center>
				<form action="uploadnew19.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
						
						<div class="form-group">
							  <label for="yearly">Policy Number</label>
							  <input class="form-control input-lg" id="yearly" name="policy" type="text">
						</div>
						<div class="form-group">
							  <label for="yearly">Starting Period</label>
							  <input class="form-control input-lg" id="yearly" name="date" type="date">
						</div>
						<div class="form-group">
							  <label for="yearly">Ending Period</label>
							  <input class="form-control input-lg" id="yearly" name="date2" type="date">
						</div>
					...
					<div class="col-md-4">
					<div class="form-group">
							  <label for="yearly">Amount (Incurred by the MD ,TSSGDCFL)</label>
							  <input class="form-control input-lg" id="yearly" name="amd" type="text">
						</div>
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							  <label for="treat">Date Of Distribution of Medicines</label>
							  <input class="form-control input-lg" id="treat" type="date" name="date3" >
						</div>
						<div class="form-group">
							  <label for="treat">Amount Utilized(INR)</label>
							  <input class="form-control input-lg" id="treat" type="text" name="auti" >
						</div>
						<div class="form-group">
							  <label for="treat">Date of Distribution of Feed</label>
							  <input class="form-control input-lg" id="treat" type="date" name="date5" >
						</div>
					</div>
					<div class="col-md-4">
						
						<div class="form-group">
							  <label for="treat">Quntity of Feed Supplied(In Kgs)</label>
							  <input class="form-control input-lg" id="treat" type="text" name="qfeed" >
						</div>
						</div>
						<div class="col-md-4">
						<div class="form-group">
							  <label for="treat">Amount Utilized(INR)</label>
							  <input class="form-control input-lg" id="treat" type="text" name="auti2" >
						</div></div>
						<div class="col-md-4">
						<div class="form-group">
							  <label for="treat">Total Expenditure of the Project</label>
							  <input class="form-control input-lg" id="treat" type="text" name="texp" >
						</div></div>
						<div class="col-md-4">
						<div class="form-group">
							  <label for="treat">Subsidy</label>
							  <input class="form-control input-lg" id="treat" type="text" name="subs" >
						</div></div>
						<div class="col-md-4">
						<div class="form-group">
							  <label for="treat">Non Subsidy</label>
							  <input class="form-control input-lg" id="treat" type="text" name="nsub" >
						</div></div>
						<div class="col-md-4">
						<div class="form-group">
							  <label for="treat">Remarks</label>
							  <input class="form-control input-lg" id="treat" type="text" name="remark" >
						</div></div>
