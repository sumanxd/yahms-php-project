...
<body>
						...
						<li><a href="#">Welfare Schemes</a>
							<ul>
								...
								<li><a href="#">Piggeries</a>
									<ul>
										<li><a href="../WS/pig/indent">Indent From The Field</a> </li>
										<li><a href="../WS/pig/payment">Payment Particulars</a></li>
									</ul>
								</li>
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Milch Payment</h2></center>
				<form action="uploadnew29.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
						
						
						
						
  <label for="yearly">Type of Miltch</label>
