...
<div class="container">
<div class="container" >
			<h1 style="text-align:center">Fodder Indent</h1>
...
$fetch="SELECT id,seed,cost,subs,beni,mandal,village,quan,file FROM tbl19 WHERE village = '".$name."'  LIMIT 0, 30";
...
echo "Error:".(mysqli_error($con));
							...
							while($data=mysqli_fetch_assoc($result))  
							{
								...
								<td><a href="../alldata/uploadindent/<?php echo $data['file'] ?>" target="_blank">view file</a></td>
