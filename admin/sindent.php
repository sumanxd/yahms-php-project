...
<div class="container">
<div class="container" >
			<h1 style="text-align:center">Sunandini Indent</h1>
...
$fetch="SELECT id,chaff,cost,subs,beni,mandal,village,iq,file FROM tbl25 WHERE village = '".$name."'  LIMIT 0, 30";
...
echo "Error:".(mysqli_error($con));
							...
							while($data=mysqli_fetch_assoc($result))  
							{
								...
								<td><a href="../alldata/uploadsuindent/<?php echo $data['file'] ?>" target="_blank">view file</a></td>
