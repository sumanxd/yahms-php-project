...
<div class="container">
<div class="container" >
			<h1 style="text-align:center">Backyard Payment</h1>
...
$fetch="SELECT id,seed,cost,subs,ppaid,mandal,village,ppre,tp,bp,cro,file FROM tbl24 WHERE village = '".$name."'  LIMIT 0, 30";
...
echo "Error:".(mysqli_error($con));
							...
							while($data=mysqli_fetch_assoc($result))  
							{
								...
								<td><a href="../alldata/uploadbpayment/<?php echo $data['file'] ?>" target="_blank">view file</a></td>
