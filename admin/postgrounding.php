...
$fetch="SELECT id,policy,date,date2,amd,mandal,village,date3,auti,date5,qfeed,auti2,texp,subs,nsub,remark,file FROM tbl16 WHERE village = '".$name."'  LIMIT 0, 30";
