...
<div class="container">
<div class="container" >
			<h1 style="text-align:center">Core Indicators</h1>
...
$fetch="SELECT id,date,farmer,mandal,village,milk,meat,eggs,file FROM tbl15 WHERE village = '".$name."'  LIMIT 0, 30";
...
echo "Error:".(mysqli_error($con));
							...
							while($data=mysqli_fetch_assoc($result))  
							{
								...
								<td><?php echo $data['meat'] ?></td>
								<td><?php echo $data['eggs'] ?></td>
								<td><?php echo $data['file'] ?></td>
								<td><a href="../alldata/uploadcore/<?php echo $data['file'] ?>" target="_blank">view file</a></td>
