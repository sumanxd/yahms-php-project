...
<div class="container-fluid">
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Preventive Deworming</h2></center>
				<form action="uploadnew8.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
					...
					<div class="col-md-4">
						<div class="form-group">
							  <label for="goatd">Goat Dewormed</label>
							  <input class="form-control input-lg" id="goatd" type="text" name="goat">
						</div>
						<div class="form-group">
							  <label for="sheepd">Sheep Dewormed</label>
							  <input class="form-control input-lg" id="sheepd" type="text" name="sheep">
						</div>
						<div class="form-group">
							  <label for="calfd">Calf Dewormed</label>
							  <input class="form-control input-lg" id="calfd" type="text" name="calf" >
						</div>
					</div>
