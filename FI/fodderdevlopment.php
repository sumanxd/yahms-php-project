...
<html>
<head>
	<title>Fodder Development</title>
...
<div class="container-fluid">
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Fodder Development</h2></center>
				<form action="uploadnew12.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
						
						<div class="form-group">
							  <label for="yearly">Quantity of Seed Given</label>
							  <input class="form-control input-lg" id="yearly" name="seed" type="text">
						</div>
						<div class="form-group">
							  <label for="monthly">Quantity Cost</label>
							  <input class="form-control input-lg" id="monthly" type="text" name="cost">
						</div>
						<div class="form-group">
							  <label for="daily">Quantity Spent</label>
							  <input class="form-control input-lg" id="daily" type="text" name="spent" >
						</div>
						
					</div>
					<div class="col-md-4">
						<div class="form-group">
							  <label for="farmer">Total Amount to Be Remitted</label>
							  <input class="form-control input-lg" id="farmer" name="amrem" type="text">
						</div>
						<div class="form-group">
							  <label for="farmer">Amount Remitted Up-To-Date</label>
							  <input class="form-control input-lg" id="farmer" name="upto" type="text">
						</div>
						<div class="form-group">
					...
					<div class="col-md-4">
						<div class="form-group">
							  <label for="noofai">Date of Recap/Batch No</label>
							  <input class="form-control input-lg" id="noofai" type="text" name="recap">
						</div>
						<div class="form-group">
							  <label for="bb">Balance Amount</label>
							  <input class="form-control input-lg" id="bb" type="text" name="balance">
						</div>
						<div class="form-group">
						...
						<!--<div class="form-group">
							  <label for="calfd">Calf Dewormed</label>
							  <input class="form-control input-lg" id="calfd" type="text" name="ai_calfd" >
						</div>-->
					</div>
