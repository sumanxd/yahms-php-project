...
<div class="container-fluid">
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Fertility Camps</h2></center>
				<form action="uploadnew13.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							  <label for="treat">No. Of Camps Done</label>
							  <input class="form-control input-lg" id="treat" type="text" name="camps" >
						</div>
					</div>
