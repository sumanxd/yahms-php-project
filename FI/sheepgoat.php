...
<div class="container-fluid">
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Sheep & Goat</h2></center>
				<form action="uploadnew3.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
						
						<div class="form-group">
							  <label for="yearly">Yearly</label>
							  <input class="form-control input-lg" id="yearly" name="yearly" type="text">
						</div>
						<div class="form-group">
							  <label for="monthly">Monthly</label>
							  <input class="form-control input-lg" id="monthly" type="text" name="monthly">
						</div>
						<div class="form-group">
							  <label for="daily">Daily</label>
							  <input class="form-control input-lg" id="daily" type="text" name="daily" >
						</div>
						
					</div>
					<div class="col-md-4">
						<div class="form-group">
							  <label for="farmer">Name Of The Farmer</label>
							  <input class="form-control input-lg" id="farmer" name="farmer" type="text">
						</div>
						<div class="form-group">
					...
					<div class="col-md-4">
						<div class="form-group">
							  <label for="tentaive">Tentative</label>
								<select class="form-control input-lg" id="tentaive" name="tentative" type="text">
									<option value="item0">--Select--</option>
									<option value="item1">Systemic</option>
									<option value="item2">Digestive</option>
									<option value="item3">Respiratory</option>
									<option value="item4">Urogenital</option>
									<option value="item5">Dermatology</option>
									<option value="item6">Major Surgery</option>
									<option value="item7">Minor Surgery</option>
									<option value="item8">Specimen Collected</option>
									
								</select>
						</div>
						<div class="form-group">
							  <label for="history">History</label>
							  <input class="form-control input-lg" id="history" type="text" name="history">
						</div>
						<div class="form-group">
							  <label for="treat">Treatment</label>
							  <input class="form-control input-lg" id="treat" type="text" name="treatment" >
						</div>
					</div>
