...
<div class="container-fluid">
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Farmer Awarness</h2></center>
				<form action="uploadnew14.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							  <label for="treat">Name of the Program</label>
							  <input class="form-control input-lg" id="treat" type="text" name="program" >
						</div>
					</div>
