...
<div class="container-fluid">
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Vaccination</h2></center>
				<form action="uploadnew10.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
						
						<div class="form-group">
							  <label for="vname">Vaccine Name</label>
							  <input class="form-control input-lg" id="vname" name="vacc_name" type="text">
						</div>
						<div class="form-group">
							  <label for="qspent">Quantity Spent</label>
							  <input class="form-control input-lg" id="qspent" type="text" name="vacc_spent">
						</div>
						<div class="form-group">
							  <label for="qdis">Quantity Discarded</label>
							  <input class="form-control input-lg" id="qdis" type="text" name="vacc_discared" >
						</div>
						<div class="form-group">
							  <label for="qhand">Quantity in Hand</label>
							  <input class="form-control input-lg" id="qhand" name="vacc_inhand" type="text">
						</div>
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							  <label for="vdate">Date Of Recap/Batch No</label>
							  <input class="form-control input-lg" id="vdate" type="text" name="vacc_date">
						</div>
					</div>
					<div class="col-md-4">
						
						<div class="form-group">
							  <label for="botrec">Bottles Received</label>
							  <input class="form-control input-lg" id="botrec" type="text" name="vacc_bottlesrec">
						</div>
						<div class="form-group">
							  <label for="bottlesdis">Bottles Disposed</label>
							  <input class="form-control input-lg" id="bottlesdis" type="text" name="vacc_bottlesdis" >
						</div>
						<div class="form-group">
							  <label for="bottlesinhand">Bottles In Hand</label>
							  <input class="form-control input-lg" id="bottlesinhand" type="text" name="vacc_bottlesinhand" >
						</div>
						<div class="form-group">
							  <label for="remarks">Remarks</label>
							  <input class="form-control input-lg" id="remarks" type="text" name="vacc_remarks" >
						</div>
					</div>
