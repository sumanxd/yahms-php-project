...
<div class="container-fluid">
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Castration</h2></center>
				<form action="uploadnew9.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">
					...
					<div class="col-md-4">
						<div class="form-group">
							  ...
							  <input class="form-control input-lg" id="Castration" type="text" name="cast">
						</div>
						<!--<div class="form-group">
							  <label for="sheepd">Sheep Dewormed</label>
							  <input class="form-control input-lg" id="sheepd" type="text" name="cast_sheep">
						</div>
						<div class="form-group">
							  <label for="calfd">Calf Dewormed</label>
							  <input class="form-control input-lg" id="calfd" type="text" name="cast_calfd" >
						</div>-->
					</div>
