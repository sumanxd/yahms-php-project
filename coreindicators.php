...
<body>
	...
	<section class="space">
		<div class="container">
			<div class="row ">
			<center><h2>Core Indicators</h2></center>
				<form action="uploadnew16.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()"  id="myfrm1">
					<div class="col-md-4">						
						...
						<div class="form-group">
							  <label for="treat">Farmer Name</label>
							  <input class="form-control input-lg" id="treat" type="text" name="farmer" >
						</div>						
					</div>
					<div class="col-md-4">						
						<div class="form-group">
					...
					<div class="col-md-4">
						...
						<div class="form-group">
							  <label for="treat">Milk Produced</label>
							  <input class="form-control input-lg" id="treat" type="text" name="milk" >
						</div>
						<div class="form-group">
							  <label for="treat">Meat Produced</label>
							  <input class="form-control input-lg" id="treat" type="text" name="meat" >
						</div>
						<div class="form-group">
							  <label for="treat">Eggs Produced</label>
							  <input class="form-control input-lg" id="treat" type="text" name="eggs" >
						</div>
					</div>
